...
#AGRONAVE: Copy local conf

cp ../sources/meta-agronave/conf/local.conf $BUILD_DIR/conf/local.conf
...
#AGRONAVE: Add meta agronave to bblayers
echo "BBLAYERS += \"\${BSPDIR}/sources/meta-agronave\"" >> $BUILD_DIR/conf/bblayers.conf
